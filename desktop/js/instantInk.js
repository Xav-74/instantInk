...
function printEqLogic(_eqLogic) {
	...
	document.getElementById('printer_img').src = 'plugins/instantInk/data/' + $('.eqLogicAttr[data-l2key=printerId]').value() + '.png';
	document.getElementById('printer_img').onload = function() { 
	}

	document.getElementById('printer_img').onerror = function() { 
		document.getElementById('printer_img').src = "plugins/instantInk/data/image_printer_not_found.png"; 
	}
};
...
$('#bt_sync').on('click', function () {
	...
	$.ajax({																// fonction permettant de faire de l'ajax
		...
		url: "plugins/instantInk/core/ajax/instantInk.ajax.php", 			// url du fichier php
		data: {
			action: "synchronize",
		},
		dataType: 'json',
